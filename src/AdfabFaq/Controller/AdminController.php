...
class AdminController extends AbstractActionController
{
    ...
    public function createAction()
    {
        ...
        $viewModel->setTemplate('adfab-faq/admin/faq');
    ...
    public function getOptions()
    {
        if (!$this->options instanceof ModuleOptions) {
            $this->setOptions($this->getServiceLocator()->get('adfabfaq_module_options'));
        }
    ...
    public function getFaqMapper()
    {
        if (null === $this->faqMapper) {
            $this->faqMapper = $this->getServiceLocator()->get('adfabfaq_faq_mapper');
        }
    ...
    public function getAdminFaqService()
    {
        if (null === $this->adminFaqService) {
            $this->adminFaqService = $this->getServiceLocator()->get('adfabfaq_faq_service');
        }
