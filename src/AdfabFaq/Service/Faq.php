...
namespace AdfabFaq\Service;

use Zend\ServiceManager\ServiceManagerAwareInterface;
use Zend\ServiceManager\ServiceManager;
use ZfcBase\EventManager\EventProvider;
use Zend\Stdlib\Hydrator\ClassMethods;
use AdfabFaq\Options\ModuleOptions;
...
class Faq extends EventProvider implements ServiceManagerAwareInterface
{
    ...
    {
        $form  = $this->getServiceManager()->get('adfabfaq_faq_form');
     ...
     * getActiveFaqs
     *
     * @return Array of AdfabFaq\Entity\Faq
     */
    public function getActiveFaqs()
    {
        $em = $this->getServiceManager()->get('adfabfaq_doctrine_em');

        $query = $em->createQuery('SELECT f FROM AdfabFaq\Entity\Faq f WHERE f.isActive = true ORDER BY f.position ASC');
    ...
    public function getAllFaqs()
    {
        ...
        $query = $em->createQuery('SELECT f FROM AdfabFaq\Entity\Faq f ORDER BY f.position ASC');
        $faqs = $query->getResult();
    ...
    public function getFaqMapper()
    {
        if (null === $this->faqMapper) {
            $this->faqMapper = $this->getServiceManager()->get('adfabfaq_faq_mapper');
        }
    ...
    public function getOptions()
    {
        if (!$this->options instanceof ModuleOptions) {
            $this->setOptions($this->getServiceManager()->get('adfabfaq_module_options'));
        }
